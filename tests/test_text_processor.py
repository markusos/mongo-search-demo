...
class TestTextChunker:
    ...
    def test_fixed_split_basic(self):
        ...
        chunker = TextChunker(chunk_size=50, overlap=10, strategy=ChunkingStrategy.FIXED)
    ...
    def test_fixed_split_overlap(self):
        ...
        chunker = TextChunker(chunk_size=20, overlap=5, strategy=ChunkingStrategy.FIXED)
    ...
    def test_semantic_split_paragraphs(self):
        ...
        chunker = TextChunker(chunk_size=100, strategy=ChunkingStrategy.SEMANTIC)
...
This is the third paragraph. It contains even more information."""
    ...
    def test_semantic_split_sections(self):
        ...
        chunker = TextChunker(chunk_size=200, strategy=ChunkingStrategy.SEMANTIC)
...
Content in the second section with different details."""
    ...
    def test_semantic_split_large_paragraph(self):
        ...
        chunker = TextChunker(
            chunk_size=50, overlap=10, min_chunk_length=20, strategy=ChunkingStrategy.SEMANTIC
        )
    ...
    def test_hybrid_split(self):
        ...
        chunker = TextChunker(chunk_size=100, strategy=ChunkingStrategy.HYBRID)
...
"""
    ...
    def test_minimum_chunk_length(self):
        ...
        chunker = TextChunker(chunk_size=50, overlap=10, min_chunk_length=100)
    ...
    def test_chunk_preserves_title(self):
        ...
        chunker = TextChunker(
            chunk_size=50, overlap=10, min_chunk_length=20, strategy=ChunkingStrategy.FIXED
        )
    ...
    def test_chunk_indices_are_sequential(self):
        ...
        chunker = TextChunker(chunk_size=50, overlap=10, min_chunk_length=20)
    ...
    def test_fixed_split_with_section(self):
...
class TestTextProcessor:
    ...
    def test_process_article(self):
        ...
        chunker = TextChunker(chunk_size=100, min_chunk_length=20)
        processor = TextProcessor(chunker)
...
Line 3"""
    ...
    def test_process_article_empty_text(self):
...
Many historians consider it a pivotal moment in European history."""
    ...
    def test_hybrid_combines_benefits(self):
        ...
        chunker = TextChunker(
            chunk_size=80, overlap=15, min_chunk_length=20, strategy=ChunkingStrategy.HYBRID
        )
...
class TestEdgeCases:
    ...
    def test_text_exactly_chunk_size(self):
        ...
        chunker = TextChunker(
            chunk_size=20, overlap=5, min_chunk_length=10, strategy=ChunkingStrategy.FIXED
        )
